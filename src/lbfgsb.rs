use crate::*;
use crate::bindings::{FG, FG_END, NEW_X, START};

use anyhow::Result;


// [[file:../lbfgsb.note::*util][util:1]]
fn is_fg(task: u32) -> bool {
        ...
        E: FnMut(&[f64], &mut [f64]) -> Result<f64>,
{
    ...
    pub(crate) fn minimize(&mut self) -> Result<()> {
        ...
        loop {
            ...
            } else if self.task == NEW_X as u32 {
...
pub fn lbfgsb<E>(x: Vec<f64>, bounds: &[(f64, f64)], eval_fn: E, m: usize, factr: f64, pgtol: f64, iprint: i32) -> Result<LbfgsbState<E>>
    where
        E: FnMut(&[f64], &mut [f64]) -> Result<f64>,
{
